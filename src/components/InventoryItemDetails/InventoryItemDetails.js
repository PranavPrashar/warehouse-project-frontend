        ...
        <div className="inventoryitemdetails">
          <div className="inventoryitemdetails__top">
            <div className="inventoryitemdetails__top--left">
              <img onClick={handleBackClick} className="inventoryitemdetails__img" src={arrowbackIcon} alt="arrow back icon" />
              {this.state.currentProduct.itemName}
            </div>
            <div className="inventoryitemdetails__top--right">
              <Link to={`/edit/inventory/${this.props.match.params.itemID}`} className="inventoryitemdetails__top--right--button">
