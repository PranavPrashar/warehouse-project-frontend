            ...
            return (
                    <article key={inventory.id} className="inv__cardcomponent">
                        <section className="inv__cardcomponent__inventory">
                            <div className="inv__cardcomponent__inventory__left">
                                <div className="inv__cardcomponent__inventory__left--item">
                                    ...
                                    <h3 className="inv__cardcomponent__inventory__left--item--color">{inventory.itemName}
                        ...
                        <section className="inv__cardcomponent__action">
                            ...
                            }}  src={deleteLogo} alt="garbage logo" />
                            {openModal && <DeleteInventoryModal selectedInventory={props.selectedInventory} closeModal={setOpenModal}/>}
                            </div>
                            <NavLink to={`/edit/inventory/${inventory.id}/`} className="inv__cardcomponent__action--img">
